// The elected bodies, shared by both designs. Newest first.
// ponytail: "K. Srinivas" was listed twice in the 2026 source note; kept once.
// Say the word if they are two different people and it goes back in.
export const BODIES = [
  {
    year: '2026',
    note: 'Heartiest congratulations to all the newly elected members.',
    office: [
      ['Honorary President', 'K. V. Rajasekhar'],
      ['President', 'G. Praveen Chary'],
      ['Vice Presidents', 'A. Shekar & K. Anil Kumar'],
      ['General Secretary', 'G. Raveendra Reddy'],
      ['Treasurer', 'T. Rajeev Reddy'],
      ['Joint Secretaries', 'B. Ravi Kumar & T. Shravan Kumar'],
      ['Advisors', 'Y. Dayakar Reddy & MSP Prasad Reddy']
    ],
    members: [
      'Allabhaksha',
      'Vemula Krishna',
  ...
  },
  {
    year: '2018',
    office: [
      ['President', 'K. V. Rajasekhar'],
      ['Vice President', 'M. Chandra Sekhar'],
      ['General Secretary', 'M. Sivarama Prasad Reddy'],
      ['Joint Secretary', 'P. Jeya Kumar'],
      ['Treasurer', 'U. Srinivasa Rao']
    ],
    members: [
      'L. Srinivasulu Reddy',
      'Siddharth Singh',
      'G. Srinivasa Chandrasekhar',
      'K. Veerabhadra Anantha Kumar'
    ]
  }
];
